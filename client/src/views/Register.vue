	...
	<div class="register">
		<section class="form-container">
			<div class="manage_tip">
				...
				<el-form :model="registerUser" :rules="rules" ref="registerFrom" label-width="90px" class="demo-ruleForm" style="margin-top:20px;"
				 size="medium">
					...
					<el-form-item>
						<el-button type="primary" class="submit-btn" @click="submitForm('registerFrom')">注册</el-button>
					</el-form-item>
				</el-form>
				<div class="text-right">已注册账号，现在<router-link to="/login" class="text-blue font-weight" style="text-decoration: none;">登录</router-link></div>
			</div>
		</section>
	</div>
</template>
